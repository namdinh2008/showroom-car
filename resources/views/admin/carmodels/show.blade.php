...
<div class="max-w-4xl mx-auto py-10 px-4">
    <div class="flex flex-col md:flex-row gap-8 items-center bg-white rounded-lg shadow-lg p-6">
        ...
        <div class="flex-1">
            ...
            <p class="text-2xl font-semibold mb-4 text-red-600">Giá cơ bản: ${{ isset($carModel->base_price) ? number_format($carModel->base_price) : '' }}</p>
            <div class="mb-4">
                <h2 class="text-lg font-semibold mb-2">Tuỳ chọn cấu hình:</h2>
                <ul class="space-y-2">
                    @if(isset($carModel->configurationOptions))
            ...
            <a href="{{ url('/admin/carmodels') }}" class="inline-block mt-4 px-6 py-2 bg-gray-800 text-white rounded hover:bg-gray-700 transition">Quay lại danh sách</a>
        </div>
    </div>
</div>
@endsection
